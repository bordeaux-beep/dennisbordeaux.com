...
{
	$to = 'info@dennisbordeaux.com';
	$subject = 'Contact Page Mobile Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1298"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U1284"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Type \'Lobi\':</b></td><td>' . htmlentities($_REQUEST["custom_U1350"],ENT_COMPAT,'UTF-8') . '</td></tr>';
